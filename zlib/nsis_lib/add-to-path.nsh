; Randy found this on the nullsoft wiki
; http://nsis.sourceforge.net/Path_Manipulation
; Author: KiCHiK
; NOTE:
; I removed stuff used to declare
; functions with "un." in front of them.
; We don't actually use "uninstallers" as
; NSIS defines them, so I modified this
; file to not use to uninstaller functions.
...
Function un.RemoveFromPath
  ...
  unRemoveFromPath_NT:
    ...
    Push $1
    Push "$0;"
    Call un.StrStrPath ; Find `$0;` in $1
...
Function un.RemoveFromEnvVar
  ...
  unRemoveFromEnvVar_NT:
    ...
    Push $2
    Push "$1;"
    Call un.StrStrPath ; Find `$1;` in $2
...
;
; NOTE:
; I (Kevin) changed the name of this macro
; from StrStr to StrStrPath because the name
; StrStr was conflicting with a previously
; declared macro of the same name.

!macro StrStrPath un
Function ${un}StrStrPath
...
FunctionEnd
!macroend
!insertmacro StrStrPath ""
!insertmacro StrStrPath "un."
