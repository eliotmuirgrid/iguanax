...
// RCS Info
static char *rcsid = "$Id: tLuaCOMTypeHandler.cpp,v 1.2 2012-09-10 19:19:27 nasron Exp $";
  ...
  else
  {
    ...
    try
    {
      ...
      case VT_DATE:
        {
		  ...
		  if(dateformat == NULL || (strcmp("string",dateformat)==0)) {
            ...
            lua_pushstring(L, (char *) tUtil::bstr2string(new_varg.bstrVal).c_str());
      ...
      case VT_BSTR:
        {
		  size_t computedSize;
        std::string& tmp = tUtil::bstr2string(varg.bstrVal, computedSize);
