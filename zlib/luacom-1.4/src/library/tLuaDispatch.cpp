...
// RCS Info
static char *rcsid = "$Id: tLuaDispatch.cpp,v 1.2 2012-09-10 19:19:27 nasron Exp $";
    ...
    unsigned int FAR* puArgErr)
{
  ...
  {
    retval = DISP_E_EXCEPTION;
    FillExceptionInfo(pexcepinfo, e.getMessage().c_str());
  }
                             ...
                             unsigned int *puArgErr)
{
  ...
  if(result)
  {
    FillExceptionInfo(pexcepinfo, LuaAux::makeLuaErrorMessage(result, errmsg).c_str());
    return DISP_E_EXCEPTION;
  }
