...
// RCS Info
static char *rcsid = "$Id: luacom.cpp,v 1.5 2012-09-10 19:19:27 nasron Exp $";
...
void luacom_error(lua_State* L, const std::string& message)
{
  luacom_err(L, message.c_str(), false);
}

static void luacom_APIerror(lua_State* L, const std::string& message)
{
  luacom_err(L, message.c_str(), true);
}
