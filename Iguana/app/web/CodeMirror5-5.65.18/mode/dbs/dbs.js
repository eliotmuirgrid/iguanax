CodeMirror.defineMode("dbs", function(config, parserConfig) {
  ...
  var indentUnit       = config.indentUnit,
      keywords         = kw(cKeywords),
      functions        = kw(cFunctions),
      types            = kw(cTypes),
      sqlplus          = kw(cSqlplus),
  ...
  function tokenComment(stream, state) {
    ...
    return ret("comment", "dbs-comment");
  }
